...
public class ElectionBoothImpl implements IElectionBooth {
	...
	@Override
	public boolean checkEligibility(int age, String locality, int voterId) throws InValidVoterException, LocalityNotFoundException, NotVoterIDException {
		 try {
			if(checkAge(age))
	...
	public boolean checkVoterId(int voterId) throws NotVoterIDException {
		if(voterId >= 1000 && voterId <= 9999) {
			return true;
		}
		throw new NotVoterIDException("Your voter ID is Invalid.");
